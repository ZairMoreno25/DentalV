...
interface StatusBadgeProps {
  status: "Completado" | "En Tratamiento" | "Firma Pendiente" | "Inactivo" | "CONFIRMADO" | "EN ESPERA" | "NO ASISTIÓ" | "COMPLETADO" | "CANCELADO"
}
...
export default function StatusBadge({ status }: StatusBadgeProps) {
  const styles = {
    ...
    "COMPLETADO": "bg-teal-100 text-teal-700 hover:bg-teal-100/80",
    "CANCELADO": "bg-red-100 text-red-700 hover:bg-red-100/80",
  }
