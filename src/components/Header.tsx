      ...
      <div className="flex items-center gap-6">
        ...
        >
          <div className="relative z-10 w-5 h-5 flex items-center justify-center">
            <Sun
              className={`w-3.5 h-3.5 transition-colors duration-200 ${isDark ? "text-slate-500 dark:text-slate-500" : "text-amber-500"}`}
            />
          </div>
          <div className="relative z-10 w-5 h-5 flex items-center justify-center">
            <Moon
              className={`w-3.5 h-3.5 transition-colors duration-200 ${isDark ? "text-blue-400 dark:text-blue-400" : "text-slate-400"}`}
            />
          </div>
          <div
            className={`absolute top-1 left-1 w-5 h-5 bg-white dark:bg-slate-900 rounded-full transition-transform ${isDark ? "translate-x-7" : "translate-x-0"} shadow-sm`}
          />
        </button>
        ...
        <div className="flex items-center gap-3">
          ...
          <Avatar className="w-10 h-10 border-2 border-white dark:border-slate-800 shadow-sm">
            <AvatarImage src={vaneImage} alt="Dra. Johana Vanessa" />
